...
let UpdateUserAvatarServices = class UpdateUserAvatarServices {
    ...
    execute({ user_id, avatarFilename }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!user) {
                throw new AppError_1.default('Only authenticate users can change avatar.', 401);
            }
            if (user.avatar) {

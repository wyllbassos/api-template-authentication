...
describe('UpdateProfileService', () => {
    ...
    it('should be able show the profile', () => __awaiter(void 0, void 0, void 0, function* () {
        const user = yield fakeUsersRepository.create({
            name: 'John Doe',
            email: 'johndoe@example.com',
            password: '12345',
        });
        const showUser = yield showProfile.execute({ user_id: user.id });
        expect(showUser.name).toBe('John Doe');
        expect(showUser.email).toBe('johndoe@example.com');
    }));
    it("should not be able show a non-existing user's profile", () => __awaiter(void 0, void 0, void 0, function* () {
